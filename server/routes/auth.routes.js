const { register, login, userData, forgot_password, reset_password_id_token_get, getAllUser, deleteUser, upload_image, get_image, logout, getAllUser_no_admin, getAdmin, update_user_data, verify, reset_password_id_token_post } = require("../controllers/auth.controller.js");
